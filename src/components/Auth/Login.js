...
//     // LETS TRY TO IMPLEMENT SOME OF THE VALIDATION FUNCTIONS FROM REGISTER COMPONENT FOR FUTURE SECURITY MODIFICATIONS
...
//     event.preventDefault();
//     if (this.isFormValid(this.state)) {
//       this.setState({ errors: [], loading: true }) //so the user can only Login one email at a time
//       firebase
//         .auth()
//         .signInWithEmailAndPassword(this.state.email, this.state.password)
//         .then(signedInUser => {
...
//   isFormValid = ({ email, password }) => email && password; //checking to make sure their are values for email and password
